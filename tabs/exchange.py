...
class Exchange(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.label_3 = Label((270, 30, 21, 21), self.frame_2)
        ...
        self.label_6 = Label((460, 20, 221, 41), self.frame_1)
